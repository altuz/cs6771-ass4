...
public:
     ...
     */
    btree(const btree<T>& original) : btree(original.size) {
        // Get a list of all elements in original tree
        // Insert them one by one
        auto all_values = original.bfs();
